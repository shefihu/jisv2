...
const motionCasesData = Array.from({ length: 12 }, (_, i) => ({
  id: `ID/3885GCM/2025`,
...
const AssignMotionCases = () => {
  ...
  const totalEntries = motionCasesData.length;
  const startIndex = (currentPage - 1) * entriesPerPage;
  const endIndex = startIndex + entriesPerPage;
  const visibleData = motionCasesData.slice(startIndex, endIndex);
...
export default AssignMotionCases;
